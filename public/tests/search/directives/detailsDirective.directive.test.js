...
var objectToTest = 'detailsDirectiveDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div details-directive-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: search, with name: detailsDirectiveDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<details-directive-directive></details-directive-directive>');
