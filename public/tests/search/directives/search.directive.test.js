...
var objectToTest = 'searchDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div search-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: search, with name: searchDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<search-directive></search-directive>');
