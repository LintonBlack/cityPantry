...
var objectToTest = 'detailsDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div details-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: details, with name: detailsDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<details-directive></details-directive>');
